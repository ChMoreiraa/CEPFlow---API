...
🔗 **API em produção:** [https://cepflow.onrender.com/docs](https://cepflow.onrender.com/docs)

> ⚠️ Hospedado no plano gratuito do Render: se ficar alguns minutos sem uso, a instância "dorme" e a primeira requisição depois disso pode levar até ~30s para responder enquanto o serviço acorda. Chamadas seguintes voltam ao normal.
